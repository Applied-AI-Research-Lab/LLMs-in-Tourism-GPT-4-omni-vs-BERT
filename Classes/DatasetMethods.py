...
# print(DTS.create_stratified_subset(total_rows=5000, stratified_column='Rating'))

# # Split the dataset into training, validation, and test sets.
# # Provide the column name (stratify_column) as an argument if you need to control the distribution
# print(DTS.split_dataset(stratify_column='Rating'))
